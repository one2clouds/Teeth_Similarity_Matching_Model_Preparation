...
def preprocess_and_save_obj(file_path, save_path, num_points=2048):
    ...
    filename = os.path.basename(file_path).replace('.obj', '.pt')
    # print(filename)
...
def main():
    file_names = glob.glob('/home/shirshak/00_teeth_similarity_matching/indi_teeth_lower/*/*.obj')
    save_path = Path('/home/shirshak/00_teeth_similarity_matching/data/pcd_tensors')
